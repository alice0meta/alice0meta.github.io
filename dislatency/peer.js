...
module.exports.RTCPeerConnection = window.RTCPeerConnection || window.webkitRTCPeerConnection
...
function DataConnection(peer, provider, options) {
  ...
  this.options = util.extend({serialization:'binary'}, options);
...
DataConnection.prototype._configureDataChannel = function() {
  ...
  if (!util.supports.sctp) throw new Error() // ‽
...
Negotiator._makeOffer = function(connection) {
  ...
  pc.createOffer(function(offer) {
    ...
    if (!util.supports.sctp && connection.type === 'data') throw new Error() // ‽
...
function Peer(id, options) {
  ...
  options = util.extend({
    ...
    // API key for cloud server (you don't need this if you're running your own)
    key: 'peerjs',
    path: '/',
